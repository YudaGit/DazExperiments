...
lb = [0.01, 0.02, 0.20, 0.00, 0.00, 0.01, -1.00, 0.01, -1.00];
ub = [20.0, 2.00, 3.00, 1.00, 0.50, 20.0,  1.00, 20.0,  1.00];
...
% Diagnostic starts: one at the generating values, one near them.
Qstarts(1, :) = Qgen;
Qstarts(2, :) = [9.0, 0.20, 0.90, 0.15, 0.04, 1.5, 0.00, 4.0, 0.30];

...
% Single display type with six color circles, three of which share a
% redundant color while the rest have unique colors.
% Probe: whether a redundant or non-redundant item was cued
% for report.
% Encoding duration: the duration of presenting stimuli displays, ranged
% from 50ms to 350ms in 50ms incriments.
...
design.MainReps     = 30;                % reps *per cell* in main

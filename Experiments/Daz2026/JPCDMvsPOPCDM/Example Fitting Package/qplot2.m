function qplot2(fitfunc, Pvar, Pfix, Sel, Data_in, ybounds);
% ----------------------------------------------------------------------
% Generic Q x Q plot for Experiment 2
...
% ----------------------------------------------------------------------
    ...
    errmg2 = 'QPLOT2: Wrong size data matrix, exiting...';
    ...
    axhandle =setfig22;
    qploti(co, axhandle(1), Data{1}, gtma, ta, thetaa, tmax, minrt, maxrt, ybounds, '50%', 0);
    qploti(co, axhandle(2), Data{2}, gtmb, tb, thetab, tmax, minrt, maxrt, ybounds, '25%', 0);
end

function qploti(co, axi, Datai, Gt, T, thetai, tmax, minrt, maxrt, ybounds, labi, do_xlabel)
% =======================================================================
...
% =======================================================================
  ...
  % Empirical RT quantiles in accuracy bins
   ...
   bound = 1.05 *  max(abs(ThetaCentres));
   ...
   set(gca, 'YLim', [ybounds(1), ybounds(2)]);  % maxrt
   if do_xlabel
